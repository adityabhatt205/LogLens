"""CLI command group: loglens export."""
...
def export_report(
    ...
    title: str = typer.Option("LogLens Security Report", "--title", help="Report title."),
    ...
    Examples::
        ...
        loglens export report
        loglens export report --since 24h --severity high --output daily.md
        loglens export report --open
    """
