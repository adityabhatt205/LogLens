...
from loglens.rules.loader import build_engine, load_rules_dir, validate_rule_file
...
def scan(
    ...
    if explain_findings and findings:
        ...
        from loglens.llm.prompts import explain_finding_prompt
    ...
    if classify and events:
        from loglens.llm.factory import make_llm_client
        from loglens.llm.prompts import classify_events_prompt
