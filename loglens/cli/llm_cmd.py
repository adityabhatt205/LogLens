...
from loglens.llm.retrieval import build_chroma_index, retrieve_context
...
def llm_summarize(
    ...
    if not rows:
        typer.echo("No errors found. Run 'loglens scan --track-errors' first.")
        return
...
def llm_index(
    ...
    """Build (or rebuild) the ChromaDB embedding index for 'loglens llm ask'.
