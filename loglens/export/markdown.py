...
from loglens.models import FindingSeverity
...
def generate_report(
    ...
    title: str = "LogLens Security Report",
) -> str:
    ...
    lines += [
        "---",
        "",
        f"*Generated by [LogLens](https://github.com/adityabhatt/loglens) v0.1.0 — {generated}*",
    ]
